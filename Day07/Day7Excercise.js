    ...
    function printFullName(firstName, lastName){
       ...
       console.log(printFullName("Adebayo", "Grace"));
...
// Density of a substance is calculated as follows:density= mass/volume. Write a function which calculates density. 
    ...
    const density = (mass, volume) => {
        densityOfSubstance = mass / volume
...
// Speed is calculated by dividing the total distance covered by a moving object divided by the total amount of time taken. Write a function which calculates a speed of a moving object, speed.
    ...
    const speed = (distanceCovered, timeTaken) => {
        speedOfMovingObject = distanceCovered / timeTaken;
...
const weight = (mass, gravity) => {
    weightOfSubstance = mass * gravity;
    return weightOfSubstance;
}

    console.log (weight( 6, 2));
...
// Write a function called checkSeason, it takes a month parameter and returns the season:Autumn, Winter, Spring or Summer.
            ...
            function checkSeason (){
                ...
                const rangeMonth = (start, stop, step) =>
                    Array.from(
